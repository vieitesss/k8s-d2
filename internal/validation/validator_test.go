...
namespaces: {
  ...
  id_61707073: {
    ...
    svc_id_6167656e742d737663: {
      label: "⎈ agent-svc\nClusterIP"
      style.fill: "#cce5ff"
    }
    svc_id_6167656e742d737663 -> %s
  }

}
`, render.WorkloadID("DaemonSet", "node-agent"), render.WorkloadID("DaemonSet", "node-agent"))
...
func TestD2Validator_ValidateWorkloadLabelsRejectsDaemonSetReplicaDrift(t *testing.T) {
	...
	actual := fmt.Sprintf("# Generated by k8s-d2\ndirection: right\n\nvars: {\n  d2-legend: {\n    daemonset: {\n      label: \"◈ DaemonSet\"\n      style.fill: \"#f9f9f9\"\n    }\n  }\n}\n\nnamespaces: {\n\n  id_61707073: {\n    label: \"apps\"\n    style.fill: \"#f0f0f0\"\n\n    %s: {\n      label: \"◈ node-agent (3)\"\n    }\n  }\n\n}\n", render.WorkloadID("DaemonSet", "node-agent"))
...
`, render.WorkloadID("Deployment", "shared-api"))
